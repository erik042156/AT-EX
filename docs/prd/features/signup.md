...
**작성 일자**: 2026-07-20  
**최종 수정일**: 2026-07-21 (Country 드롭다운 옵션/기본값 확인, 테스트 환경 확인 사항 반영)  
**버전**: 1.3  
...
### 확인 필요
- 테스트 계정 준비 방식 (사전 생성 vs 테스트 중 동적 생성)
...
### 버전 관리
- **이 PRD 버전**: 1.3 (Country 드롭다운 옵션/기본값 확인, 테스트 환경 확인 사항(테스트 계정 생성 가능 여부, 사이트 접근 제약, 계정 정리 정책) 반영)
- **작성일**: 2026-07-20
- **최종 검토일**: 2026-07-21 (Country 드롭다운 옵션/기본값 및 테스트 환경 확인 사항 재확인)
- **최종 승인일**: (예정)
